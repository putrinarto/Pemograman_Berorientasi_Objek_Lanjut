...
class Dashboard:
    ...
    def menuAdmin(self):
        ...
        admin_menu.add_command(
            label='Data Buku', command= lambda: self.new_window("Menu Data Buku", FrmBuku)
        )
        admin_menu.add_command(
            label='Data Peminjaman', command= lambda: self.new_window("Menu Data Peminjaman", FrmPeminjaman)
        )
        admin_menu.add_command(
            label='Data Pengembalian', command= lambda: self.new_window("Menu Data Pengembalian", FrmPengembalian)
        )
        ...
        menubar.add_cascade(
            label="Menu Perpustakaan", menu=admin_menu
        )
    ...
    def menuDosen(self):
        ...
        dosen_menu.add_command(
            label='Data Dosen 1', command= lambda: self.new_window("Menu Dosen 1", )
        )
        dosen_menu.add_command(
            label='Data Dosen 2', command= lambda: self.new_window("Menu Dosen 2", )
        )
    ...
    def menuMahasiswa(self):
        ...
        mahasiswa_menu.add_command(
            label='Data Mahasiswa 1', command= lambda: self.new_window("Menu mahasiswa 1", )
        )
        mahasiswa_menu.add_command(
            label='Data Mahasiswa 2', command= lambda: self.new_window("Menu mahasiswa 2", )
        )
